...
<h1 class="map-title person-heading" style="text-align: left;">
    ...
    <div>
        ...
        <span class="editable" id="workplace" data-field="workplace">{{ $user->workplace ?? 'N/A' }}</span>
    </div>

    <div>
        <strong>School:</strong>
        <span class="editable" id="school" data-field="school">{{ $user->school ?? 'N/A' }}</span>
    </div>

    <div>
        <strong>Pensacola:</strong>
        <span class="editable" id="pensacola" data-field="Pensacola">{{ $user->Pensacola ?? 'N/A' }}</span>
    </div>

    <div>
        <strong>Date of Birth:</strong>
        <span class="editable" id="dob" data-field="dob">{{ $user->dob ? \Carbon\Carbon::parse($user->dob)->format('d M, Y') : 'N/A' }}</span>
    </div>

    <div>
        <strong>Loves:</strong>
        <span class="editable" id="loves" data-field="loves">{{ $user->loves ?? 'N/A' }}</span>
    </div>

    <div>
        <strong>Hometown:</strong>
        <span class="editable" id="home_town" data-field="home_town">{{ $user->home_town ?? 'N/A' }}</span>
    </div>

    <div>
        <strong>Current City:</strong>
        <span class="editable" id="current_city" data-field="current_city">{{ $user->current_city ?? 'N/A' }}</span>
    </div>

    <div>
        <strong>Favorite Song:</strong>
        <span class="editable" id="favorite_song" data-field="favorite_song">{{ $user->favorite_song ?? 'N/A' }}</span>
    </div>

    <div>
        <strong>Employer:</strong>
        <span class="editable" id="employer" data-field="employer">{{ $user->employer ?? 'N/A' }}</span>
    </div>

    <div>
        <strong>Job Title:</strong>
        <span class="editable" id="job_title" data-field="job_title">{{ $user->job_title ?? 'N/A' }}</span>
    </div>

    <div>
        <strong>Currently In:</strong>
        <span class="editable" id="current_city_display" data-field="current_city_display">{{ $user->current_city ?? 'N/A' }}</span>
    </div>
