@include('frontend.layout.header')
 ...
 <div class="container">
     <div class="terms-logo-img" style="    position: absolute;display: flex;">
         <a href="{{url('/')}}"><img src="assets/img/logo.png" alt="" width="100%"></a>
     </div>
     <div class="terms-main-img">
         <a href="{{url('/')}}"><img src="assets/img/invite.png" alt="" width="100%"></a>
     </div>
