...
<div class="profiles-container">
    ...
    <div class="profile-row">
        ...
        <?php if(canViewProfile(auth()->user(), $user)): ?>
        <div class="profile-card">
            <div>
                <?php if($user->profile_picture): ?>
                <img src="<?php echo e(asset($user->profile_picture)); ?>" alt="Mallory" class="profile-image">
                <?php else: ?>
            ...
            <div class="interaction-icons">
                <div class="icon" role="button" style="background: #fff;padding: 3px 4px;" aria-label="Call" onclick="navigateTo('<?php echo e(url('audio_cal/' . $user->id)); ?>?autocall=1')">📞</div>
                <div class="icon" role="button" style="background: #fff;padding: 3px 4px;" aria-label="Message" onclick="navigateTo('<?php echo e(url('text_messg/'. $user->id )); ?>')">💬</div>
                <div class="icon" role="button" style="background: #fff;padding: 3px 4px;" aria-label="video-call" onclick="navigateTo('<?php echo e(url('video_cal/' . $user->id)); ?>?autocall=1')">🎥</div>

            </div>
            <div class="name-label"><a href="<?php echo e(url('user/profile/' . $user->id)); ?>"><?php echo e($user->name); ?></a></div>
        </div>
        <?php endif; ?>
...
<?php /**PATH E:\laragon\www\animation_social\animation_social_project\resources\views/frontend/users.blade.php ENDPATH**/ ?>