    ...
    <div class="container">
        <div class="call-banner">
            <div class="speaker-icon">
                <img src="<?php echo e(asset('assets/img/mic.png')); ?>" alt="Speaker">
            </div>
          <div class="phone-icon" id="acceptAudioCallBtn" style="cursor: pointer;">
                <img src="<?php echo e(asset('assets/img/audio-answer.png')); ?>" alt="" width="50px" height="50px">
            </div>

            <div class="video-icon btn-accept" id="acceptCallBtn" style="cursor: pointer;">
                <img src="<?php echo e(asset('assets/img/video-answered.png')); ?>" alt="" width="50px" height="50px">
            </div>

             <div class="decline-icon btn-decline" id="declineVideoBtn">
                <img src="<?php echo e(asset('assets/img/video-decline.png')); ?>" alt="Chat" width="50px" height="50px">
            </div> 

            <div class="audio-decline-icon btn-decline" id="declineAudioBtn">
                <img src="<?php echo e(asset('assets/img/audio-decline (2).png')); ?>" alt="Chat" width="50px" height="50px">
            </div>
            <div class="call-title">Ringing</div>
            <div class="caller-profile-container">
                <div class="profile-circle">
                    <img src="<?php echo e(asset('assets/img/person.png')); ?>" alt="profile" class="profile-image" style="width:100px; height:100px; border-radius:50%;">
...
<?php if(auth()->guard()->check()): ?>
  window.Laravel = {
    ...
    ringtone: "<?php echo e(auth()->user()->ringtone); ?>"
  };
<?php endif; ?>
</script>
...
<script src="<?php echo e(asset('assets/js/audio_video_call_client.js')); ?>"></script>
...
<?php /**PATH E:\laragon\www\animation_social\animation_social_project\resources\views/frontend/layout/footer.blade.php ENDPATH**/ ?>