...
<body>
    <div class="login-card">
        <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Logo" width="100">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="text" id="login" name="login" class="form-control <?php $__errorArgs = ['login'];
...
<?php /**PATH E:\laragon\www\animation_social\animation_social_project\resources\views/auth/login.blade.php ENDPATH**/ ?>