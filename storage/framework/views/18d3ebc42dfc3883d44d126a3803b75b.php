...
<div class="content">
    ...
    <h2 class="pricing" style="text-align: end;" >Or use our <br> Free Version </h2>
     <a href="<?php echo e(route('free_version')); ?>" class="button_proceed">proceed</a>
 
    <div class="payment-methods">
         
        <div>
            <a href="<?php echo e(route('Creditcard')); ?>" style="color:#fff; text-decoration: none;">
                <div class="payment-label">Creditcard</div>
                <img src="assets/img/ertrey.svg" alt="Credit Card" class="payment-icon">
            </a>
        </div>
        <div>
            <a href="<?php echo e(route('venmo')); ?>" style="color:#fff; text-decoration: none;">
                <div class="payment-label">Venmo</div>
                <img src="assets/img/imagesxsd.svg" alt="Venmo" class="payment-icon">
            </a>
        </div>
        <div>
            <a href="<?php echo e(route('apply_pay')); ?>" style="color:#fff; text-decoration: none;">
...
<?php /**PATH E:\laragon\www\animation_social\animation_social_project\resources\views/frontend/yardcharz.blade.php ENDPATH**/ ?>